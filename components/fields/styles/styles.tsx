export const customStyles = (theme: string, error?: boolean) => ({
    control: (provided: any, state: any) => ({
        ...provided,
        backgroundColor: "transparent",
        border: state.isFocused ? "1px solid #2563EB" : theme === "dark" ? (error ? "1px solid #F87171" : "0px solid #E2E8F0") : (error ? "1px solid #F53939" : "1px solid #E2E8F0"),
