...
const CheckTable = (props: Props) => {
    ...
    return (
        <Card className={"h-full w-full overflow-auto no-scrollbar p-4"}>
            {openAdd && <AddAccount setOpenAdd={setOpenAdd} reloadData={reloadData} />}
            ...
            <div className="flex justify-between items-center flex-col lg:flex-row">
              ...
              linear justify-center rounded-lg font-medium dark:font-base transition duration-200`}
                            ...
                            <MdOutlineAddCircleOutline /><p className="flex gap-1">Thêm <p className="hidden sm:block">tài khoản</p></p>
                        </Button>
                    </div>
                </div>
