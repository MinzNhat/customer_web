...
const AccountTable = ({ setSelectedId, selectedId }: { setSelectedId: any, selectedId: any }) => {
    ...
    return (
        passData ? (
            data ? (
                <CheckTable columnsData={columnsData} tableData={data} reloadData={reloadData} setSelectedId={setSelectedId} selectedId={selectedId} />
            ) : (
